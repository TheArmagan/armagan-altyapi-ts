...
class CommandManager {
    constructor(ul) {
        _loadCommands.set(this, () => __awaiter(this, void 0, void 0, function* () {
            Log_1.Log.info(`Starting to load commands!`);
            let commandFiles = yield recursiveReadDir(path.resolve(__dirname, "commands"));
            ...
            yield chillout.forEach(commandFiles, (commandFile) => __awaiter(this, void 0, void 0, function* () {
                ...
                Log_1.Log.success(`Command "${cmd.name}" is loaded!`);
            }));
            Log_1.Log.success(`All commands(${this.commands.size}) successfully loaded!`);
        }));
        _startMessageListener.set(this, () => {
            Log_1.Log.info("Starting to listen for the commands!");
            ...
            Log_1.Log.success("Started to listen for the commands!");
        });
        this.ul = ul;
